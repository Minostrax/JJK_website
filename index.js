...
arc1.addEventListener("click", () => {
    ...
    BckgrdArcs.style.background = 'url("wallpapersden.com_77225-1920x1080.jpg")'
    BckgrdArcs.style.backgroundRepeat = "no-repeat"
    BckgrdArcs.style.backgroundSize = "cover"
    BckgrdArcs.style.backgroundPosition = "center"
})
...
arc2.addEventListener("click", () => {
    ...
    BckgrdArcs.style.background = 'url("ARC2-history.jpg")'
    BckgrdArcs.style.backgroundRepeat = "no-repeat"
    BckgrdArcs.style.backgroundSize = "cover"
    BckgrdArcs.style.backgroundPosition = "center"
...
arc3.addEventListener("click", () => {
    ...
    BckgrdArcs.style.background = 'url("arc3-history.jpg")'
    BckgrdArcs.style.backgroundRepeat = "no-repeat"
    BckgrdArcs.style.backgroundSize = "cover"
    BckgrdArcs.style.backgroundPosition = "center"
})
arc4.addEventListener("click", () => {
    ...
    BckgrdArcs.style.background = 'url("arc4-history.webp")'
    BckgrdArcs.style.backgroundRepeat = "no-repeat"
    BckgrdArcs.style.backgroundSize = "cover"
    BckgrdArcs.style.backgroundPosition = "center"
})
